      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-border-default text-text-tertiary transition-colors duration-200 hover:border-border-strong hover:text-white"
            aria-label="GitHub"
          >
        ...
        <div className="mt-10 text-center">
          ...
          <p className="mt-2 text-xs text-text-tertiary opacity-30">
            DaBarkle &middot; {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
